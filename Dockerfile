...
RUN wget https://apache.mirrors.nublue.co.uk/tomcat/tomcat-9/v9.0.41/bin/apache-tomcat-9.0.41.tar.gz
RUN tar -zxvf apache-tomcat-9.0.41.tar.gz -C /opt/tomcat --strip-components=1
